...
const WA_URL = (n: CWBNeighborhood) =>
  `https://wa.me/5541997452053?text=${encodeURIComponent(`Olá! Quero um orçamento de marketing digital para minha empresa em ${n.name}, ${n.city}.`)}`;
