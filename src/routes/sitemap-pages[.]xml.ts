    ...
    handlers: {
      GET: async ({ request }) => {
        ...
        return renderSitemap(resolveBaseUrl(request), [
          ...
          { path: "/criacao-sites", changefreq: "weekly", priority: "0.85" },
          { path: "/desenvolvimento", changefreq: "weekly", priority: "0.8" },
          { path: "/seo", changefreq: "weekly", priority: "0.85" },
          { path: "/ia", changefreq: "weekly", priority: "0.8" },
          { path: "/automacao", changefreq: "weekly", priority: "0.8" },
          { path: "/trafego-pago", changefreq: "weekly", priority: "0.8" },
